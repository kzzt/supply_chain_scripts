...
def read_email_list():
    ...
    wb = openpyxl.load_workbook("c:\\users\\u6zn\\desktop\\write_off_mail_list_followup.xlsx")
    sheet = wb["Sheet1"]
    recipients_list = {}
